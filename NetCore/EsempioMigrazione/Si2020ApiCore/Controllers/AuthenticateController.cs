...
namespace Si2020ApiCore.Controllers
{
    [ApiController]
    public class AuthenticateController : ControllerBase
    {
        ...
        public AuthenticateController(ILogger<AuthenticateController> logger, IUserService userService, IJwtAuthManager jwtAuthManager)
        {
            _logger = logger;
